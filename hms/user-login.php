...
<body class="login">
    <div class="patient__wrap">
        <div class="row">
            <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
                <div class="logo margin-top-30">
                    <a href="../index.html">
                        <h2 class="heading" style="text-align: center;"> <span>MediSmart | Patient Login</span></h2>
                    </a>
                </div>
                ...
                <div class="box-login">
                    <form class="form-login" method="post">
                        <fieldset>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-lg btn-primary pull-right" name="submit">
                    ...
                    <div class="copyright">
                        &copy; <span class="current-year"></span><span class="text-bold text-uppercase">
                            MediSmart</span>. <span>All rights reserved</span>
                    </div>
